...
export function EmptyState({ 
  ...
  return (
    <Card className={cn("flex flex-col items-center justify-center p-12 text-center bg-surface-raised/30 border-dashed border-2", className)}>
      {icon ? (
        <div className="mb-5 text-content-tertiary bg-surface p-4 rounded-full border border-border/50 shadow-sm">
          {icon}
        </div>
      ) : (
        <div className="mb-5 text-content-tertiary bg-surface p-4 rounded-full border border-border/50 shadow-sm">
